...
//  GDW
//
//  Created by Niamat Zawad on 2021/06/21.
//
#pragma once
#include <cmath>
#include <inttypes.h>
...
typedef uint64_t ulong; //type def used to specify an alternative name for a type

#define CAST(T, x) static_cast<T>(x)
#define PUN(T, x) *(T*)&x //Type punning. Casting between different pointers. Note this is very dangerous!
...
namespace math
{
    ...
    {
        constexpr A dx = x1 - x2;
        constexpr B dy = y1 - y2;
